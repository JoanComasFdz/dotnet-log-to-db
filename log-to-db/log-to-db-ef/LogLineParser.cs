...
{
    internal static IEnumerable<LogEntry> ToLogEntry(this IEnumerable<string> logLines, string logFileName)
    {
        return logLines.Select(x => ParseLogEntry(x, logFileName));
    }

    internal static LogEntry ParseLogEntry(string logLine, string logFileName)
    {
